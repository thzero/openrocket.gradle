...
// thzero - begin
        stream = this.getClass().getResourceAsStream("/rocksim/BodyTubeChildrenTest.rkt");
// thzero - end
...
// thzero - begin
        try (InputStream stream = RockSimLoaderTest.class.getResourceAsStream("/rocksim/" + fileName)) {
// thzero - end
